...
var routes = [{
  path: '/dashboard',
  component: __webpack_require__(/*! ../components/DashboardComponent.vue */ "./resources/js/components/DashboardComponent.vue")
}, {
  path: '/profile',
  component: __webpack_require__(/*! ../components/ProfileComponent.vue */ "./resources/js/components/ProfileComponent.vue")
}];
